...
<script type="text/javascript">
	...
	function newpwCheck() {
		if (document.getElementById("newpass").value != document
				.getElementById("newpassre").value) {
			...
			<div id="pd3">
				...
				<form name="update_form" action="updatePro.jsp" method="post">
					<table>
						...
						<tr>
							<td>새 비밀번호 확인</td>
							<td><input type="password" name="newpwre" id="newpassre"
								onchange="newpwCheck()" />&nbsp;<span id="newpack"></span></td>
						</tr>
						<tr>
							<td>이름</td>
						...
						<tr>
							...
							<td><input type="date" name="birthdate"
								value="<%=rs.getString("birthday")%>" /></td>
						</tr>
						<tr>
							<td>이메일</td>
