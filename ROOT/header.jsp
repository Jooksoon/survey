...
<body>
	<%
	String id = (String)session.getAttribute("sessionID");	// 현재 로그인되어있는 id
	
	if (session.getAttribute("sessionID") == null) {	// 로그인이 되어있지 않은 경우
	%>
	<div id="top">
	...
	<%
	} else if(id.equals("polinsight")&& id!=null){		// 관리자 계정인 경우(현재 "polinsight"계정이 관리자로 지정되어 있음)
	%>
	<div id="top">
		<span id="bookmark">즐겨찾기 추가</span><span id="top_menu"><span
			class="top_menu_d" onclick="location.href='index.jsp';">홈</span> <span
