...
<%
	...
	/* 페이지네이션 구현 */
    int showRows = 10;	// 한 페이지당 표시할 최대 튜플 수
    int totalRecords = 5;	// 한 화면 당 표시할 최대 페이지 수
...
<body>
	...
	<div class="main">
		...
		<div class="surveylist">
            ...
            %>
					<tr>
						...
						<td><%=rs1.getString("ID")%></td>	<!--ID 불러옴-->
						<td><%=rs1.getString("NAME")%></td>	<!--NAME 불러옴-->
						<td><%=rs1.getString("TYPE")%></td>  <!--tYPE 불러옴-->
						<td>%</td>
		...
		<br>
		<div class="surveynav">
			<form class="surveynav-form">	<!--페이지네이션 버튼 만들기-->
			   ...
			   <!--prev 버튼-->
				<span id="prev"><a
					href="managePanel.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"
				...
				<span class="numbers"><a href="managePanel.jsp?iPageNo=<%=i%>"
				...
				<!--next 버튼-->
				<span id="next"><a
					href="managePanel.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>" class="next-span"
